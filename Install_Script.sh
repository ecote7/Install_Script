...
export PATH=$PATH:/usr/local/go/bin | tee -a /etc/profile.d/golang.sh
export GOPATH=$HOME/go | tee -a /etc/profile.d/golang.sh
export GOCACHE=$HOME/.cache/go-build | tee -a /etc/profile.d/golang.sh
export PATH=$PATH:$GOPATH/bin | tee -a /etc/profile.d/golang.sh
...
export PATH=$PATH:/home/ubuntu/.local/bin | tee -a /etc/profile
